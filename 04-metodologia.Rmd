...
Se identifican un total de  `r total_ceros` registros de variables con valores cero. 

```{r casoscero}
cols_excluir <- c("cantidad_insumo_1", "cantidad_insumo_2")
...
En total son 9 ordenes de producción donde algunoas de sus variables presentaron valores en cero.
8 de estas ordenes ya se habían identificado con los NA de los insumos. En esta revisión se identifica una orden adicional, la cual revisando con operaciones, también confirma que obedeció a un error de tipeo.
