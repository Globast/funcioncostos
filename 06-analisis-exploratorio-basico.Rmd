...
```{r tipo-equipo,  out.width = "65%", echo=FALSE}
...
```{r equipo-id,  out.width = "65%", message=FALSE, warning=FALSE}
...
```{r categoria-producto,  out.width = "65%", message=FALSE, warning=FALSE}
...
```{r modalidad-proceso,  out.width = "65%", message=FALSE, warning=FALSE}
...
```{r num-insumos,  out.width = "65%", message=FALSE, warning=FALSE}
...
```{r insumo-1,  out.width = "65%", message=FALSE, warning=FALSE}
...
```{r insumo-2,  out.width = "65%", message=FALSE, warning=FALSE}
