...
resumen_bivariado_ci <- datos %>%
  ...
  kableExtra::kable_styling(full_width = FALSE) 
```
El comportamiento de los costos de insumo por tipo de equipo muestra una estructura menos homogénea que la observada en costos de transformación. Aquí no solo cambian los niveles, sino también la forma de la distribución.

Los equipos A1 y B2 presentan patrones similares: medias cercanas a 5 UM/unidad y medianas ligeramente inferiores. Esto indica una leve asimetría positiva, consistente con la presencia de algunos valores altos, pero en general con un comportamiento relativamente estable. El rango intercuartílico es moderado, lo que sugiere que el consumo de insumos en estos equipos es predecible y controlado.

El equipo C3 nuevamente se diferencia de forma clara. La media (≈11.25) es más del doble que en A1 y B2, y la dispersión es considerable. Además, la mediana se mantiene alta, lo que indica que no se trata solo de valores extremos, sino de un nivel estructuralmente elevado. Este patrón sugiere que C3 no solo es más costoso en transformación, sino también en insumos, lo que refuerza la idea de un proceso intrínsecamente más intensivo o menos eficiente.

El caso de D4 es el más interesante. Aunque presenta la media más baja (≈3.58), su desviación estándar es alta y supera incluso a la media. La mediana (≈1.64) está muy por debajo de la media, lo que indica una asimetría extrema. Esto implica que la mayoría de los casos tienen costos bajos, pero existen algunos valores muy altos (máximo ≈46) que distorsionan el promedio. En otras palabras, D4 es generalmente eficiente, pero con episodios puntuales de alto consumo.

En conjunto, los costos de insumo muestran mayor sensibilidad a eventos extremos y menor estabilidad que los costos de transformación, especialmente en ciertos equipos.
