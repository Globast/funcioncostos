...
Cantidad de insumo 2
Tiene menor número de observaciones (n = 124), lo que indica que no está presente en todos los procesos. Su mediana es 1 y el IQR es 1.25, lo que muestra una concentración aún mayor que en el insumo 1. La dispersión es baja y los valores extremos (máximo 7) son menos pronunciados. Esto sugiere que el segundo insumo actúa como un componente opcional o complementario, con consumo bajo y controlado.

Lectura integrada

El sistema es altamente variable en escala (volumen), moderadamente variable en tiempo y relativamente estable en consumo de insumos.
La asimetría positiva es consistente en todas las variables, lo que indica la presencia de eventos de alta intensidad (lotes grandes, procesos largos, consumos altos), aunque no dominan el comportamiento típico.
Existe una clara diferenciación funcional:
el volumen introduce heterogeneidad estructural
la duración refleja complejidad operativa
los insumos muestran regularidad en la ejecución

Conclusión

El sistema no es homogéneo: combina variabilidad estructural en producción con regularidad en consumo de recursos. La principal fuente de heterogeneidad no está en los insumos, sino en el tamaño de los lotes y la duración de los procesos. Esto sugiere que cualquier modelamiento o mejora operativa debe centrarse en segmentar por escala de producción y complejidad del proceso, más que en el consumo de insumos.
