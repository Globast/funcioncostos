...
Relación casi perfecta entre el costo de transformación y el costo unitario total (0.971). Este resultado no es sorprendente, ambas variables contienen prácticamente la misma información, por lo que analizarlas por separado aporta poco valor adicional.
