...
tabla_resumen_num <- bind_rows(var_num_vol, var_num_dur, var_num_ci1, var_num_ci2) %>%
  select(variable, everything()) %>%
  mutate(
    across(c(media, ds, `50%`, minimo, maximo, Q1, Q3, IQR), ~ round(., 2))
  ) %>%
  rename(
    Variable = variable,
    n = n,
...
knitr::kable(
  tabla_resumen_num,
  caption = "Resumen descriptivo de las variables numéricas seleccionadas",
  ...
  kableExtra::column_spec(2:10, width = "7em")
```
