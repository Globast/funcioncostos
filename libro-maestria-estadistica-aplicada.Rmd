...
- *Duración del proceso*, es heterogéneo también pero más controlado. La media  (`r round(dur_proceso_media,2)`) es superior a la mediana (`r round(dur_proceso_mediana,2)`), nuevamente cola derecha. El IQR muestra que la mitad de los procesos se concentra entre 60 y 150 horas, lo que define un rango operativo razonablemente estable. Sin embargo, el máximo de 482 horas apunta a procesos excepcionalmente largos.
