...
En transformación: se observa un gradiente claro X (27.9) < Y (31.4) < Z (41.6), confirmado por la mediana. Pero la dispersión cambia entre modalidades: X tiene desviación estándar de 17.9 (proceso volátil), Y tiene 10.5 (proceso controlado), Z tiene 17.3 pero con IQR contenido (alto y consistente).
En insumo: el patrón es más suave (X: 4.8, Y: 5.2, Z: 6.9), y la mediana de Z (4.98) está muy cerca de la de Y. El sobrecosto de Z proviene principalmente del componente de transformación, no del de insumos.
...
Limitación crítica. El n de Z es de 14 órdenes. Cualquier conclusión cuantitativa sobre Z tiene intervalos de confianza muy amplios. Z aparece aquí como observación cualitativa, no como base para inferencia.
