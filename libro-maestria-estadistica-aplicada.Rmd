...
```{r setup, include=FALSE}
knitr::opts_chunk$set(
  echo = FALSE,      # Oculta el código en todo el documento
  message = FALSE,   # Oculta mensajes de carga de librerías
  warning = FALSE,   # Oculta advertencias
  out.width = "100%",# Gráficas al ancho completo
  fig.align = "center"
)
```
...
```{r ck_hist_ct,  out.width="100%",echo=FALSE}
library(dplyr)
library(ggplot2)
library(tibble)
...
```{r box_num_predictoras,  echo=FALSE}
p_vol <- datos %>%
...
```{r hist_num_predictoras,  echo=FALSE}
library(ggplot2)
library(dplyr)
library(patchwork)
