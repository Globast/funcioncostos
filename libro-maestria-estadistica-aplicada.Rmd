...
Se identifican un total de  `total_ceros` registros con valores cero los cuales hay que entrar a analizar según la variable, al tratarse de costos, no puede tener costos en cero, o tiempos de proceso en cero. por esto se verifica . 
Hay `total_vacios` registros vacios.
